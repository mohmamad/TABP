...
namespace TABP.Infrastructure.Migrations
{
    ...
    [Migration("20240623181058_Add_Delete_Hotel")]
    partial class Add_Delete_Hotel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TABP.Domain.Entities.HotelType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            HotelTypeId = new Guid("a7e01843-d8f5-4a28-875f-3b925eb19e64"),
                            Type = "perfect"
                        },
                        new
                        {
                            HotelTypeId = new Guid("0de1e7b6-2cfb-4bf9-a931-91b01490082e"),
                            Type = "nice"
                        });
                });
            ...
            modelBuilder.Entity("TABP.Domain.Entities.RoomType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoomTypeId = new Guid("807239a5-1448-409a-8eb9-9c3a70b27350"),
                            Type = "perfect"
                        },
                        new
                        {
                            RoomTypeId = new Guid("a5177f7f-a4d6-435c-9101-13d89dcfc03d"),
                            Type = "nice"
                        });
                });
